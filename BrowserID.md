...
[Engine Light](https://github.com/codeforamerica/engine-light) (Ruby),
[Oakland Answers](https://github.com/codeforamerica/oakland_answers) (Ruby),
[Louisville Jail Dashboard](https://github.com/codeforamerica/in-n-out) (PHP),
[Long Beach AddressIQ](https://github.com/codeforamerica/address-iq) (Python),
[Pittsburgh Template-Maker](https://github.com/codeforamerica/template-maker) (Python),
and [Oakland RecordTrac](https://github.com/codeforamerica/recordtrac) (Python).
...
* Watching for login and logout actions
  in [Javascript](https://github.com/codeforamerica/engine-light/blob/d71dafa39555013385f6ed45d977269e1ebecd33/app/views/layouts/_navbar.html.erb#L20).
